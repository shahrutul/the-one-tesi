...
set output 'ridondanza_multiHop_10perc.eps'
...
plot 'datiRidondanzaMultiHop.dat' using 2 ti "M2MShare_1_hop" lw 3, '' u 3 ti "M2MShare_2_hop" ls 8 lc rgb "dark-green"  lw 3, '' u 4 ti "M2MShare_3_hop" lw 3
