...
\usepackage[final]{pdfpages}			%aggiungere in allegato dei pdf
...
\input{4-movimento/movimento}
\input{5-simulatore/simulatore}
\input{6-implementazione/implementazione}
\input{7-simulazione/simulazione}
...
\includepdf[pages=1-7]{paper.pdf}
