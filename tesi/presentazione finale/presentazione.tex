...
\ \\
\pause
Delega selettiva solo verso i nodi più promettenti: nodi incontrati più frequentemente.
\end{frame}
...
\textbf{Obiettivo:} aggiornare M2MShare aggiungendo la possibilità di delega multi-hop e analizzare l’efficienza di M2MShare originale (1-hop) rispetto alla nuova versione  (con deleghe fino a 3 hop)
\end{frame}
