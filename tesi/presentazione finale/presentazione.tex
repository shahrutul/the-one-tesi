...
\end{center}
\ \\
Esempio: colleghi di lavoro, pendolari, famigliari, ecc..
\end{frame}
...
\begin{center}
\begin{figure}  
\multiinclude[<+->][format=eps,graphics={scale=0.8}]{mappe/mappa} 
\caption{Average explored area employing M2MShare with different multi-hop versions} 
...
%{\includegraphics[scale=0.38]{mappe/M2MShare_1_hop_50perc.eps}}\qquad
%\vspace{-10pt}%
%\pause
%\subfigure[Explored area with 2-hop]%
%{\includegraphics[scale=0.38]{mappe/M2MShare_2_hop_50perc.eps}}\qquad
%\vspace{-10pt}%
%\pause
%\subfigure[Explored area with 3-hop]%
%{\includegraphics[scale=0.38]{mappe/M2MShare_3_hop_50perc.eps}}
%\end{figure}
\end{frame}
...
\begin{center}
\begin{figure}[ht]
\includegraphics[scale=0.65]{delegheMultiHopPerc.eps}
