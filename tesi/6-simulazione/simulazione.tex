...
\begin{figure}[htpb]
  \begin{center}
    \includegraphics[scale=1]{grafici/tempi.eps}
...
\begin{figure}[htpb]
  \begin{center}
    \includegraphics[scale=1]{grafici/delegheFatte.eps}
...
\begin{figure}[htpb]
  \begin{center}
    \includegraphics[scale=1]{grafici/percDeleghe.eps}
...
\begin{figure}[htpb]
  \begin{center}
    \includegraphics[scale=1]{grafici/data.eps}
