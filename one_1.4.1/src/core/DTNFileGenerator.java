...
public class DTNFileGenerator {
	...
	public void generateFiles() {
		//System.err.println(requests.size() + " files generation requests loaded");
		List<DTNHost> hosts = simScenario.hosts;
		//int nrofGroupsWithFiles = simScenario.nrofGroupsWithFiles;
		...
		for(int i=0; i<requests.size(); i++){
			...
			if(mode.equals("A")){
				/*int filePerGroup = nrOfCopies / nrOfGroups;
