...
set output 'tempiVF_Fp5_zoom.eps'
...
plot 'datiTempiVF_Fp5' using 2:xtic(1) ti col lc rgb "blue" lt 1  lw 3, '' u 3 ti col lc rgb "red" lt 2  lw 3, '' u 4 ti col  ls 8 lc rgb "dark-green" lt 3  lw 3
