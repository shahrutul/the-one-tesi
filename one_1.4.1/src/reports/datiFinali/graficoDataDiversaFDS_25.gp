...
plot 'datiDataDiversaFDS_25MB.dat'  using 3:xtic(1) ti col fs pattern 3, '' u 2 ti col fc rgb "dark-green" fs pattern 2, '' u 4 ti col fs pattern 7 lw 4
