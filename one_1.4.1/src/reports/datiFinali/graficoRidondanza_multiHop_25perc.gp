...
set output 'ridondanza_multiHop_25perc.eps'
...
plot 'datiRidondanzaMultiHop.dat' using 5 ti "M2MShare_1_hop" lw 3, '' u 6 ti "M2MShare_2_hop" ls 8 lc rgb "dark-green"  lw 3, '' u 7 ti "M2MShare_3_hop" lw 3
